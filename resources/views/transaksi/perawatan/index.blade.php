                    ...
                    <table class="table" id="example" class="table table-striped table-bordered" style="width:100%">
                      ...
                      @foreach($data as $val)  
                        <tr>
                            ...
                            @if(Auth::user()->level == 'Admin')
                            <td>
                              <a href="/transaksi/perawatan/edit/{{$val->id}}"><i class="fas fa-edit"></i> </a>
                              <a href="/transaksi/perawatan/delete/{{$val->id}}" onclick="return confirm('Apa Anda yakin ?')"><i class="fas fa-trash"></i> </a>
                            </td>
                            @else
                            @endif
                        </tr>
