@extends('layouts.app', ['activePage' => 'profile', 'titlePage' => __('Edit Perbaikan')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="/permintaan/perbaikan/ubah" autocomplete="off" class="form-horizontal">
            @csrf
