              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  <div class="row">
                    ...
                    <div class="col-6">
                      <h4 class="card-title text-right"><a href="/user/perbaikan/tambah" class="btn btn-primary">Tambah</a></h4>
                    </div>
                  </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table" id="example" class="table table-striped table-bordered" style="width:100%">
                      ...
                      @foreach($data as $val)  
                        <tr>
                            ...
                            @if(Auth::user()->level == 'Admin')
                            <td>
                              <a href="/permintaan/perbaikan/edit/{{$val->id}}"><i class="fas fa-edit"></i> </a>
                              <a href="/permintaan/perbaikan/delete/{{$val->id}}" onclick="return confirm('Apa Anda yakin ?')"><i class="fas fa-trash"></i> </a>
                            </td>
                            @else
                            @endif
                        </tr>
