@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Maintenance Machines')])
...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="/daftar/store">
        @csrf

        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title"><strong>{{ __('Form Pendaftaran') }}</strong></h4>
          </div>
          <div class="card-body">
