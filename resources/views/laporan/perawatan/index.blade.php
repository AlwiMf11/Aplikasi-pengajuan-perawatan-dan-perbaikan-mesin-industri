@extends('layouts.app', ['activePage' => 'profile', 'titlePage' => __('Laporan Perawatan')])
            ...
            @endif
              <div class="card">
                <div class="card-header card-header-primary">
                  <div class="row">
                    <div class="col-6">
                      <h4 class="card-title pt-3">Laporan Perawatan</h4>
                    </div>
                    <div class="col-6">
                    <h4 class="card-title text-right"><a href="/laporan/perawatan/print" class="btn btn-primary">Print</a></h4>
                    </div>
                  </div>
                </div>
                <div class="card-body">
