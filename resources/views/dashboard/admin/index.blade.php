@extends('layouts.app', ['activePage' => 'profile', 'titlePage' => __('Dashboard Admin')])
    <!-- datatable bootstrap -->
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-primary card-header-icon">
              ...
              <h3 class="card-title"> {{$admin->count() }}/{{$teknisi->count() }}/{{$users->count() }}
                <small></small>
              </h3>
            </div>
            <div class="card-footer">
              <div class="stats">
                ...
                <a href="javascript:;"> {{$admin->count() }} Admin / {{$teknisi->count() }} Teknisi / {{$users->count() }} Users</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              ...
              <p class="card-category">Data Mesin</p>
              <h3 class="card-title"> {{$mesin->count() }}
                <small></small>
              </h3>
            </div>
            <div class="card-footer">
              <div class="stats">
                <i class="material-icons text-danger">warning</i>
                <a href="javascript:;"> {{$mesin->count() }} Mesin</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-dark card-header-icon">
              ...
              <p class="card-category">Data Divisi</p>
              <h3 class="card-title"> {{$divisi->count() }}
                <small></small>
              </h3>
            </div>
            <div class="card-footer">
              <div class="stats">
                <i class="material-icons text-danger">warning</i>
                <a href="javascript:;"> {{$divisi->count() }} Divisi</a>
              </div>
            </div>
          </div>
        </div>
